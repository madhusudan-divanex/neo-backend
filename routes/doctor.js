...
doctor.post('/change-password', authMiddleware, checkPermission("doctors", "updateProfile"), changePassword)
doctor.post('/reset-password', authMiddleware, resetPassword)
doctor.put('', authMiddleware, checkPermission("doctors", "updateProfile"), updateDoctor)
doctor.delete('', authMiddleware, deleteDoctor)
doctor.post('/kyc', uploader.fields([{ name: 'frontImage', maxCount: 1 },
{ name: 'backImage', maxCount: 1 }
]), authMiddleware, checkPermission("doctors", "updateProfile"), doctorKyc)
doctor.get('/kyc/:id', getDoctorKyc)
doctor.post('/education-work', authMiddleware, checkPermission("doctors", "updateProfile"), doctorEduWork)
...
doctor.post('/clinic', authMiddleware, checkPermission("doctors", "updateProfile"), uploader.fields([
  { name: 'clinicImage', maxCount: 1 },
  { name: 'licenseImage', maxCount: 1 }
]), doctorClinicData)
doctor.get('/clinic/:id', authMiddleware, getDoctorClinic)
doctor.post('/medical-license', authMiddleware, checkPermission("doctors", "updateProfile"), uploader.any(), doctorLicense)
...
doctor.post('/about', authMiddleware, checkPermission("doctors", "updateProfile"), doctorAbout)
doctor.get('/about/:id', authMiddleware, getDoctorAbout)
doctor.post('/edit-request', authMiddleware, checkPermission("doctors", "updateProfile"), editRequest)


doctor.post('/update-image', authMiddleware, checkPermission("doctors", "updateProfile"), uploader.fields([{ name: 'profileImage', maxCount: 1 }
]), updateImage)
...
doctor.post('/time-slot', authMiddleware, checkPermission("doctors", "updateProfile"), addTimeSlot)
...
doctor.delete('/time-slot/:slotId', authMiddleware, checkPermission("doctors", "updateProfile"), deleteTimeSlot)
