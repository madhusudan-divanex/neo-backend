...
import { createStaffEmployement, createStaffProffessional, createStaffProfile, getStaffById, getStaffByNHId, getStaffEmployement, getStaffList, staffAction, staffLogin, staffResendOtp, updateStaffEmployement, verifyOtp } from '../controller/staffController.js'
...
staff.get('/employment', authMiddleware, getStaffEmployement)
...
staff.post('/resend-otp', staffResendOtp)
