...
admin.get('/panel-staff/:id', adminAuth, getPanelStaff)
admin.get('/birth-certificate', adminAuth, getBirthCertificates)
...
admin.get('/allotment', adminAuth, getAllotmentList)
