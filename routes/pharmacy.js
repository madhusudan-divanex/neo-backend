...
pharmacy.post('/change-password', authMiddleware, checkPermission("pharmacy", "updateProfile"), changePassword)
pharmacy.post('/reset-password', authMiddleware, checkPermission("pharmacy", "updateProfile"), resetPassword)

pharmacy.put('', authMiddleware, checkPermission("pharmacy", "updateProfile"), updatePhar)
pharmacy.delete('', authMiddleware, checkPermission("pharmacy", "updateProfile"), deletePhar)

pharmacy.post(
    '/license',
    authMiddleware,
    checkPermission("pharmacy", "updateProfile"),
    uploader.fields([
...
pharmacy.post('/about', authMiddleware, checkPermission("pharmacy", "updateProfile"), pharAddress)
pharmacy.post('/person', authMiddleware, checkPermission("pharmacy", "updateProfile"), uploader.fields([{ name: 'photo' }]), pharPerson)
pharmacy.post('/edit-request', authMiddleware, checkPermission("pharmacy", "updateProfile"), editRequest)


pharmacy.post('/update-image', authMiddleware, checkPermission("pharmacy", "updateProfile"), uploader.fields([{ name: 'logo', maxCount: 1 }]), updateImage)

pharmacy.post('/image', authMiddleware, checkPermission("pharmacy", "updateProfile"), uploader.fields([{ name: 'thumbnail' }, { name: 'pharImg' }]), pharImage)
