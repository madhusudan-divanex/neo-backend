...
async function seed() {
  ...
  const faqData = [
    ...
    ["Can I consult a doctor online?", "Yes, NeoHealthCard supports video consultations. Select Video Consult when booking."],
  ...
  const notifTemplates = [
    ...
    { t: "Welcome to NeoHealthCard", m: "Welcome! Your NeoHealthCard account is now active.", type: "general" },
